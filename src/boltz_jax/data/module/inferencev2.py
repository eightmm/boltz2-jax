...
from boltz_jax.data.feature.featurizerv2 import Boltz2Featurizer
from boltz_jax.data.mol import load_canonicals, load_molecules
from boltz_jax.data.pad import pad_to_max
from boltz_jax.data.tokenize.boltz2 import Boltz2Tokenizer
...
class PredictionDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        if self.affinity:
            # Lazy import: AffinityCropper lives in boltz_jax.data.crop (not
            # copied for the protein-only path). Only needed when affinity=True.
            from boltz_jax.data.crop.affinity import AffinityCropper
