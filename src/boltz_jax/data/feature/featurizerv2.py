...
from boltz_jax.data._external import center_random_augmentation
from boltz_jax.data.mol import (
    get_amino_acids_symmetries,
    get_chain_symmetries,
    get_ligand_symmetries,
    get_symmetries,
)
from boltz_jax.data.pad import pad_dim
from boltz_jax.data.types import (
    MSA,
    MSADeletion,
    MSAResidue,
    MSASequence,
...
def process_token_features(  # noqa: C901, PLR0915, PLR0912
    ...
    binder_pocket_conditioned_prop: float | None = 0.0,
    contact_conditioned_prop: float | None = 0.0,
    binder_pocket_cutoff_min: float | None = 4.0,
    binder_pocket_cutoff_max: float | None = 20.0,
    binder_pocket_sampling_geometric_p: float | None = 0.0,
    only_ligand_binder_pocket: bool | None = False,
    only_pp_contact: bool | None = False,
    inference_pocket_constraints: list[tuple[int, list[tuple[int, int]], float]] | None = False,
    inference_contact_constraints: list[tuple[tuple[int, int], tuple[int, int], float]] | None = False,
...
def process_atom_features(
    ...
    max_tokens: int | None = None,
    disto_use_ensemble: bool | None = False,
...
class Boltz2Featurizer:
    ...
    def process(
        ...
        disto_use_ensemble: bool | None = False,
        fix_single_ensemble: bool | None = True,
        max_tokens: int | None = None,
        max_atoms: int | None = None,
        pad_to_max_seqs: bool = False,
        ...
        only_ligand_binder_pocket: bool | None = False,
        only_pp_contact: bool | None = False,
        single_sequence_prop: float | None = 0.0,
        msa_sampling: bool = False,
