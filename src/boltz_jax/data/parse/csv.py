"""Vendored from boltz.data.parse.csv (self-contained, no `import boltz`).

Parses CSV MSA files into the MSA dataclass. Imports remapped to boltz_jax.
"""
...
from boltz_jax.data.types import MSA, MSADeletion, MSAResidue, MSASequence
