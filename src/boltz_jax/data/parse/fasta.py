...
from boltz_jax.data.parse.yaml import parse_boltz_schema
from boltz_jax.data.types import Target
...
def parse_fasta(  # noqa: C901, PLR0912
    ...
    """
    # Read fasta file
    from Bio import SeqIO  # lazy: biopython only needed for the FASTA path
