...
from boltz_jax.data.types import Structure
...
def to_mmcif(
    ...
    # Lazy import: ihm/modelcif/rdkit are heavy writer-only deps for cif output,
    # kept off module import so PDB output needs none of them.
    import ihm
    import modelcif
