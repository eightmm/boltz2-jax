...
class InferenceOptions:
    ...
    pocket_constraints: list[tuple[int, list[tuple[int, int]], float, bool]] | None = None
    contact_constraints: list[tuple[tuple[int, int], tuple[int, int], float, bool]] | None = None
...
class MDInfo:
    ...
    prod_ensemble: str | None
    solvent: str | None
    ion_concentration: float | None  # mM
    time_step: float | None  # fs
    sample_frame_time: float | None  # ps
    sim_time: float | None  # ns
    coarse_grained: bool | None = False
...
class TemplateInfo:
    ...
    template_en: int
    force: bool = False
    threshold: float | None = float("inf")
...
class Target:
    ...
    residue_constraints: ResidueConstraints | None = None
    templates: dict[str, StructureV2] | None = None
    extra_mols: dict[str, Mol] | None = None
...
class Tokenized:
    ...
    residue_constraints: ResidueConstraints | None = None
    templates: dict[str, StructureV2] | None = None
    template_tokens: dict[str, np.ndarray] | None = None
    template_bonds: dict[str, np.ndarray] | None = None
    extra_mols: dict[str, Mol] | None = None
